...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = (
        ...
        "  Company:\n"
        "    • `/run @RegisterCompany`\n"
        "    • `/run @CompanyCounterpartyCreation`\n"
        "    • `/run @CompanyRepresentativesCreation`\n"
        "    • `/run @CompanyWalletCreation`\n"
        "    • `/run @CompanyWalletTransactionCreate`\n"
        "  Individual:\n"
        "    • `/run @RegisterIndividual`\n"
        "    • `/run @IndividualCounterpartyCreation`\n"
        "    • `/run @IndividualWalletCreation`\n\n"
        "*API tests:*\n"
        "  Company:\n"
        "    • `/run @RegisterCompanyAPI`\n"
        "    • `/run @CompanyCounterpartyCreationAPI`\n"
        "    • `/run @CompanyRepresentativesCreationAPI`\n"
        "    • `/run @CompanyWalletCreationAPI`\n"
        "    • `/run @CompanyWalletTransactionCreateAPI`\n"
        "  Individual:\n"
        "    • `/run @RegisterIndividualAPI`\n"
        "    • `/run @IndividualCounterpartyCreationAPI`\n\n"
